...
- LLM provider rate limits/quota can temporarily block live LLM parsing.
...
- Deterministic intent parser fallback is enabled when LLM calls fail, preserving end-to-end functionality.
